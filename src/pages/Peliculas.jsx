...
//       try {
//         const respuesta = await fetch(`https://api.themoviedb.org/3/movie/${id}?api_key=192e0b9821564f26f52949758ea3c473&language=es-MX&append_to_response=genres`);

//         if (respuesta.status === 200) {
//           const datos = await respuesta.json();
//           setPelicula(datos);
//         } else {
//           console.log("Hubo un error al cargar la película");
//         }
//       } catch (error) {
//         console.log(error);
//       }
